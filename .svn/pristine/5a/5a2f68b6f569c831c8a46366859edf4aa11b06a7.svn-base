...
<script>
import {
  listRole, getRole, delRole, addRole, updateRole, exportRole, dataScope, changeRoleStatus
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm(`确定要${text}${row.roleName}角色吗？`, '警告', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => changeRoleStatus(row.roleId, row.status)).then(() => {
