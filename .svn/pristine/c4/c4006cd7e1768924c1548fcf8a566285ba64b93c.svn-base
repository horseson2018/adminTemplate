<template>
  <div class='app-container'>
    ...
    <el-row :gutter='10' class='mb8'>
      ...
      <el-col :span='1.5'>
        <el-button
          ...
          :disabled='single'
          @click='handleUpdate'
          v-hasPermi='["deploy:setting:edit"]'
        >修改</el-button>
      </el-col>
      <el-col :span='1.5'>
        <el-button
          ...
          :disabled='multiple'
          @click='handleDelete'
          v-hasPermi='["deploy:setting:remove"]'
        >删除</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading='loading' :data='auditorList' @selection-change='handleSelectionChange'>
      ...
      <el-table-column label='阈值名称' align='center' prop='settingName' />
      <el-table-column label='阈值' align='center' prop='settingValue'/>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        settingValue: [
          {
            required: true, validator: checkSetval, trigger: ['blur', 'change']
          }
        ]
      }
    };
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map((item) => item.settingName)
    ...
    handleUpdate(row) {
      this.reset();
      const id = row.settingName || this.ids[0]
